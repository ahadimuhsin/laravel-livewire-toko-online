                    ...
                    <div class="card-body">
                                ...
                                <tr style="background: #edf2f7">
                                    ...
                                    <td class="b-none" width="50%">
                                        ...
                                        <table class="table-borderless" style="font-size: 14px">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: .20rem">:</td>
                                                <td style="padding: .20rem">{{ $product->unit_weight }} {{ $product->unit }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="b-none text-right">
                                        <div class="text-right">
                                            <button
                                            wire:click="removeCart({{ $product->id }})"
                        ...
                        <table class="table table-default">
                            <tbody>
                                ...
                                <tr>
                                    <td class="set-td border-0 text-left" width="60%">
                                        <p class="m-0">Discount</p>
                                    </td>
                                    <td class="set-td border-0 text-right" width="30%">
                                        &nbsp; : Rp.
                                    </td>
                                ...
                                <tr>
                                    <td class="border-0 text-left" width="60%">
                                        <p class="font-weight-bold m-0 h5 text-uppercase">
                                            Grand Total</p>
                                    </td>
                                    <td class="border-0 text-right" width="30%">
                                        &nbsp; : Rp.
                                    </td>
                                    <td class="border-0 text-right">
                                        <p class="font-weight-bold m-0 h5" id="grand_total">0</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-md-6">
                ...
                <div class="card border-0 shadow rounded-md">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    class="form-control" placeholder="No. HP / WhatsApp">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group d-none" id="courier"></div>
                        <div class="form-group d-none" id="ongkir"></div>
                    ...
                    <div class="col-md-12">
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">
                                ...
                                class="btn-voucher btn btn-dark shadow btn-md btn-block">
                                Validasi</a>
                            </div>
                        </div>
                    </div>
                ...
                <button class="btn btn-lg btn-dark shadow mt-3
                btn-block btn-checkout">Checkout</button>
                ...
                <div class="card border-0 shadow rounded-md">
                    <div class="card-body">
                        <h5>
                            <i class="fa fa-user-circle"></i>
                            Silakan Masuk / Daftar
                        </h5>
                        <hr>

                        <a href="{{ route('auth.customer.login') }}" class="btn btn-dark btn-block
                        btn-lg shadow">
                    <i class="fa fa-user-circle"></i>
                Login/Register</a>
                    </div>
...
<script>
    $(document).ready(function () {
        $(".select-provinsi , .select-kota, .select-kecamatan").select2({theme: 'classic'});
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                $.each(response.data, function (key, value) {
                    $('select[name="provinsi"]').append('<option value="' + value.province_id +
    ...
    $(document).ready(function () {
        ...
        $('select[name="kota"]').on('change', function () {
            ...
            $('#courier').append('<div class="form-check form-check-inline">\n' +
                ...
                '  <label class="form-check-label font-weight-bold mr-2" for="ongkos_kirim-jne">JNE</label>\n' +
                '  <input class="form-check-input select-courier" type="radio" name="courier" id="ongkos_kirim-tiki" value="tiki">\n' +
                '  <label class="form-check-label font-weight-bold mr-2" for="ongkos_kirim-tiki">TIKI</label>\n' +
                    ...
                    success: function (response) {
                        ...
                        $.each(response[0]['costs'], function (key, value) {
                            ...
                            $('#ongkir').append(
                                ...
                                '</strong> - Rp. ' + money_id(value.cost[0].value) +
                                ' (' + value.cost[0].etd + ' hari)</span>\n' +
                                '</div>')
                        });
                    },
                });
